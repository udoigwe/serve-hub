		...
		sa = {
			...
			SL: [
				...
				[
					,
					,
					"(?:25|3[013-5]|66|7[3-9]|8[08]|99)\\d{6}",
					,
					,
					,
					"25123456",
...
*/
	...
	function Qa(a, b, c, d, e, g) {
		...
		if (0 == h.length) f = 20;
			...
			(h = h.replace(L, "")), (b.i = ""), b.g(Ja(h)), (f = 1);
		else {
			h = new RegExp(f);
			Ka(b);
			f = b.toString();
	...
	function Sa(a, b, c, d) {
		...
		try {
			...
			if ("Invalid country calling code" == M.message && L.test(l)) {
				if (
					((l = l.replace(L, "")), (h = Qa(a, l, f, b, d, g)), 0 == h)
				)
					throw M;
			} else throw M;
		}
		...
		null != f &&
			...
			2 != a &&
				...
				5 != a &&
				((b = e),
				d && 0 < c.toString().length && u(g, 7, c.toString())));
		d = b.toString();
		a = d.length;
		if (2 > a)
			throw Error(
